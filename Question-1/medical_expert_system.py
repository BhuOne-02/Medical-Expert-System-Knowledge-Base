...
class Greetings(KnowledgeEngine):
	...
	def _initial_action(self):
		print("")
		print("Hi! I am Dr.Alexa!, I am here to help you make your health better.")
	...
	@Rule(Fact(action='find_disease'), NOT(Fact(headache=W())),salience = 12)
	def symptom_0(self):
		self.declare(Fact(headache=input("headache: ")))

	@Rule(Fact(action='find_disease'), NOT(Fact(back_pain=W())),salience = 11)
	def symptom_1(self):
	...
	@Rule(Fact(action='find_disease'), NOT(Fact(cough=W())),salience = 9)
	def symptom_3(self):
		self.declare(Fact(cough=input("cough: ")))

	@Rule(Fact(action='find_disease'), NOT(Fact(fainting=W())),salience = 8)
	def symptom_4(self):
		self.declare(Fact(fainting=input("fainting: ")))

	@Rule(Fact(action='find_disease'), NOT(Fact(sore_throat=W())),salience = 7)
	def symptom_9(self):
		self.declare(Fact(sore_throat=input("sore throat: ")))	

	@Rule(Fact(action='find_disease'), NOT(Fact(fatigue=W())),salience = 6)
	def symptom_5(self):
	...
	@Rule(Fact(action='find_disease'), NOT(Fact(low_body_temp=W())),salience = 4)
	def symptom_7(self):
	...
	@Rule(Fact(action='find_disease'), NOT(Fact(sunken_eyes=W())),salience = 2)
	def symptom_6(self):
	...
	@Rule(Fact(action='find_disease'), NOT(Fact(blurred_vision=W())),salience = 0)
	def symptom_12(self):
